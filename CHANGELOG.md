...
## 4.8.0 - 2017-04-20
* Add `\Stripe_Legacy\Stripe::setLogger()` to support an external PSR-3 compatible logger
...
## 3.0.0 - 2015-07-28
* Rename `\Stripe_Legacy\Object` to `\Stripe_Legacy\StripeObject` (PHP 7 compatibility)
