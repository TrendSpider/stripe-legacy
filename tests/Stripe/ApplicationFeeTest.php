...
class ApplicationFeeTest extends TestCase
{
    ...
    public function testIsListable()
    {
        ...
        $this->assertSame("Stripe_Legacy\\ApplicationFee", get_class($resources->data[0]));
    }
    ...
    public function testIsRetrievable()
    {
        ...
        $this->assertSame("Stripe_Legacy\\ApplicationFee", get_class($resource));
    }
    ...
    public function testCanCreateRefund()
    {
        ...
        $this->assertSame("Stripe_Legacy\\ApplicationFeeRefund", get_class($resource));
    }
    ...
    public function testCanListRefunds()
    {
        ...
        $this->assertTrue(is_array($resources->data));
        $this->assertSame("Stripe_Legacy\\ApplicationFeeRefund", get_class($resources->data[0]));
    }
}
