...
class CustomerTest extends TestCase
{
    ...
    public function testIsListable()
    {
        ...
        $this->assertSame("Stripe_Legacy\\Customer", get_class($resources->data[0]));
    }
    ...
    public function testIsRetrievable()
    {
        ...
        $this->assertSame("Stripe_Legacy\\Customer", get_class($resource));
    }
    ...
    public function testCanListInvoices()
    {
        ...
        $this->assertTrue(is_array($resources->data));
        $this->assertSame("Stripe_Legacy\\Invoice", get_class($resources->data[0]));
    }
    ...
    public function testCanListCharges()
    {
        ...
        $this->assertTrue(is_array($resources->data));
        $this->assertSame("Stripe_Legacy\\Charge", get_class($resources->data[0]));
    }
    ...
    public function testCanUpdateSubscription()
    {
        ...
        $this->assertSame("Stripe_Legacy\\Subscription", get_class($resource));
    ...
    public function testCanCreateSource()
    {
        ...
        $this->assertSame("Stripe_Legacy\\BankAccount", get_class($resource));
    }
    ...
    public function testCanUpdateSource()
    {
        ...
        $this->assertSame("Stripe_Legacy\\Card", get_class($resource));
    }
