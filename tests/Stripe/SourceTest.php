...
class SourceTest extends TestCase
{
    ...
    public function testIsRetrievable()
    {
        ...
        $this->assertSame("Stripe_Legacy\\Source", get_class($resource));
    }
    ...
    /**
     * @expectedException \Stripe_Legacy\Error\Api
     */
    ...
    public function testCanListSourceTransactions()
    {
        ...
        $this->assertSame("Stripe_Legacy\\SourceTransaction", get_class($resources->data[0]));
    }
