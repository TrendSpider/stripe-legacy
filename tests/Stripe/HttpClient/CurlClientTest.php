...
use Stripe_Legacy\HttpClient\CurlClient;
...
class CurlClientTest extends TestCase
{
    ...
    public function testDefaultOptions()
    {
        ...
        $this->setExpectedException('Stripe_Legacy\Error\Api', "Non-array value returned by defaultOptions CurlClient callback");
