...
class AccountTest extends TestCase
{
    ...
    public function testIsListable()
    {
        ...
        $this->assertSame("Stripe_Legacy\\Account", get_class($resources->data[0]));
    }
    ...
    public function testIsRetrievable()
    {
        ...
        $this->assertSame("Stripe_Legacy\\Account", get_class($resource));
    }
    ...
    public function testCanCreateLoginLink()
    {
        ...
        $this->assertSame("Stripe_Legacy\\LoginLink", get_class($resource));
    }
}
