...
abstract class Webhook
{
     ...
     * \Stripe_Legacy\SignatureVerificationException if the signature verification
     ...
     *
     * @return \Stripe_Legacy\Event the Event instance
     * @throws \UnexpectedValueException if the payload is not valid JSON,
     *  \Stripe_Legacy\SignatureVerification if the verification fails.
     */
